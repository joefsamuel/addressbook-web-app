...
class AddressBookControllerTest {
    ...
    void addBuddyInfoAPI() throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/addbuddy?name=joe&phone=232323").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("{\"id\":1,\"name\":\"joe\",\"phoneNumber\":\"232323\"}")));
    }
